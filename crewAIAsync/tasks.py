...
class AINewsletterTasks():
    def fetch_news_task(self,agent):
        return Task(
            ...
            'url': 'https://www.example.com/story1',
            'summary': 'AI make a splash in this year's Super Bowl commercials...'
            },
            {{...}}
            ]
            """
    ...
    def analyze_news_task(self,agent,context):
        return Task(
            description=f'Analyze each news story and ensure there are at least 5 well-formatted articles',
            agent=agent,
            async_excecution=True,
            context = context,
            expected_output="""A list of top AI news story titles, URLS, and a brief summary for each story from the past 24 hours
            ...
            **The details:**\n\n
            - Microsoft\'s Copilot spot shocased it's AI assistant...\n\n
            **Why it matters:&& While AI-related ads have been rampant over the last year, it's SuperBowl presentation ...            
            """
            )
    def compile_newsletter_task(self,agent,context,callback_function):
        return Task(
            ...
            Example output:
            '# Top storeis in AI today:\\n\\n
            - AI stakes spotlight in Super Bowl commercials\\n
